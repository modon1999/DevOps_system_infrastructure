...
echo "<html><body bgcolor=black><center><h2><p><font color=red>Developer Server by ${owner} with: $PrivateIP Build by Terraform! DB-address: ${db_address}. DB-port:${db_port}</h2></center></body></html>" > /var/www/html/index.html
